      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-h2 mb-2">Create your account</h2>
            <p className="text-body text-muted">
              Join thousands of traders making predictions on African events
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="agreeToTerms" className="text-body-sm text-muted ml-2">
                    I agree to the{' '}
                    <Link
                      href="/terms"
